...
> = ({ imageItems, title, description }) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={containerRef}
        className="relative mt-12 w-full cursor-grab active:cursor-grabbing overflow-x-auto"
      >
        <motion.div
          ...
          >
            {imageItems.map((item) => (
              <motion.div
                ...
                className="group relative flex h-full min-h-[15rem] w-[15rem] flex-shrink-0 cursor-pointer items-end overflow-hidden rounded-xl border border-gray-700 bg-gray-900 p-4 shadow-sm transition-shadow duration-300 ease-in-out hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
