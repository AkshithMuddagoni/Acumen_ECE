...
const Explore5 = () => {
  ...
  const galleryItems = exploreWorlds5.map((event) => ({
    id: event.id,
    title: event.title,
  ...
  const handleRegister = () => {
    window.open('https://docs.google.com/forms/d/e/1FAIpQLScTDNff49n1LQCitTSIFDPUSABn-FnItnwoSYN8ztqfFeOrbA/viewform', '_blank');
  };
      ...
      >
        ...
        >
          <p className="text-sm sm:text-base text-[#b0b0d9] mb-2">
            🎪 Explore fun and engaging non-technical events
          </p>
          <p className="text-xs sm:text-sm text-[#00ffaa] font-semibold">
            Click any event to learn more and join the fun!
          </p>
        </motion.div>
            ...
            >
              ...
              {/* Event Poster Image */}
                <motion.div 
                  ...
                  className="mb-6 sm:mb-8 rounded-xl overflow-hidden h-64 sm:h-80 md:h-96 bg-black/40 border border-[#00ffaa]/20"
                >
                  <img
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm sm:text-base text-[#b0b0d9]">
                    ...
                    <div>
                      <span className="text-[#00ffaa] font-semibold block mb-1">💰 Entry Fee</span>
                      <span className="font-bold text-[#00ffaa]">{selectedEvent.entryFee}</span>
                    </div>
                    <div className="col-span-2">
                      <span className="text-[#00ffaa] font-semibold block mb-1">🏆 Prize</span>
                      <span>{selectedEvent.prizeDetail || 'TBA'}</span>
                    </div>
                  </div>
                </motion.div>
