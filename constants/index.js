export const exploreWorlds = [
  ...
  {
    id: 'world-4',
    imgUrl: '/tech_main.png',
    title: 'Technical Events',
    pageUrl: '/RoboticEvents'
  },
  {
    id: 'world-5',
    imgUrl: '/nontech_main.png',
...
export const sponsorsList = [
...

  {
    ...
    url: 'https://vaalukasolutions.com/'
  },
 ...
 /* {
  ...
  {
    id:'sp-2',
    imgUrl:'/lotus_logo_.png',
    title: 'Lotus',
    url: 'https://lotusamt.com/'
  },
  {
    id:'sp-3',
  ...
  {
    id:'sp-4',
    imgUrl:'/lalitha_agencies_logo.png',
    title: 'Lalitha Agencies'
  },
  /*{
    id:'sp-4',
 ...
 // },
  {
    ...
    url:'https://www.instagram.com/acumen.ece?igsh=OHVpNWdtMGlpbmtw'
  },
  //{
  //  name: 'facebook',
   // imgUrl: '/facebook.svg',
...
export const coreTeam = [
  ...
  },
  {
    ...
    members: [
      { name: "Paramesh", imgUrl: "/Paramesh.jpg" },
      { name: "Sidhartha", imgUrl: "/Sidhartha.png" },
    ],
  },
  {
    department: "Coordinators for Non-Technical Events",
    members: [
      { name: "Sai Hibah", imgUrl: "/SaiHibah.jpg" },
  ...
  },
  {
    ...
    members: [
      { name: "Akshith", imgUrl: "/Akshithm.jpeg" }
    ],
  },
   {
    department: "Designing",
    members: [
      { name: "Karthikeya", imgUrl: "/Karthikeya.jpg" },
      { name: "Saujanya", imgUrl: "/Saujanya.jpg" }
    ],
  },
  {
    department: "Content Creation and Editing",
    members: [
      { name: "Ramcharan", imgUrl: "/Ramcharan.jpg" },
      { name: "Sai Tharun Reddy", imgUrl: "/Saitharun.jpeg" },
    ],
  },
  {
    department: "Marketing",
    members: [
      { name: "Rahul", imgUrl: "/Rahul.jpg" },
      { name: "Supriya", imgUrl: "/Supriya.jpg" },
    ],
  },
  {
    department: "Decor",
  ...
  },
  {
    ...
    members: [
      { name: "Sathwik", imgUrl: "/Sathwik.jpg" },
      { name: "Sriraj", imgUrl: "/Sriraj.jpg" },
    ],
  },
  {
    department: "Digital",
    members: [
      { name: "Lokesh", imgUrl: "/Lokesh.jpg" },
      { name: "Sahithya", imgUrl: "/Sahithya .jpg" },
    ],
  },
  {
    department: "Inspire and Ignite",
    members: [
      { name: "Ravindra", imgUrl: "/RAVINDRA.jpg" }
    ],
  },
];
...
export const devsTeam = [
  {
    department: "Web Dev Team",
    members: [
      { name: "VIGNESHWAR", imgUrl: "/vigneshwar.jpg", role: "DEV DEC" },
      { name: "Bharat", imgUrl: "/Bharat.jpeg" },
      { name: "Saikiran", imgUrl: "/Saikiran.jpeg" },
      { name: "Udaykiran", imgUrl: "/Udaykiran.jpeg" },
    ],
  },
];
...
export const PREVIOUS_YEARS = ['2024', '2023', '2022'];
export const ALL_YEARS = [CURRENT_YEAR, ...PREVIOUS_YEARS];
