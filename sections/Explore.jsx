...
const Explore = () => {
  ...
  return (
    ...
    <section
      className={`${styles.paddings} bg-transparent relative z-20`}
      id="explore"
    >
      <motion.div
      ...
      >
        ...
        */}
        ...
        <h2 className="font-big-heading text-[#F5F5F5] text-2xl sm:text-4xl font-bold text-center drop-shadow-[0_0_8px_#008080] sm:drop-shadow-[0_0_15px_#008080] pb-4 sm:pb-0">
          The Events
        </h2>
